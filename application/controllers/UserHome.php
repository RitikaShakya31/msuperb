...
class UserHome extends CI_Controller
{
    ...
    public function product()
    {
        ...
        $data['title'] = ' Our product | CARE1 | Your One Care Medical';
        $data['contact'] = $this->contact;
    ...
    public function contact()
    {
        ...
        $data['title'] = 'Contact Us | CARE1 | Your One Care Medical';
        $data['contact'] = $this->contact;
    ...
    public function register()
    {
        ...
        $data['title'] = 'Register - CARE1 | Your One Care Medical';
        ...
        if (count($_POST) > 0) {
            ...
            if ($count > 0) {
                ...
                $otp = rand(1000, 10000);
                $msg = "" . $otp . " is the verification code to log in to your Care1 account.";
    ...
    public function login()
    {
        ...
        $data['logo'] = 'assets/logo.png';
        $data['title'] = 'Login - CARE1 | Your One Care Medical';
        if (count($_POST) > 0) {
    ...
    {
        $data['title'] = 'Forgot Password - CARE1 | Your One Care Medical';
        if (count($_POST) > 0) {
            extract($this->input->post());
            ...
            if (!empty($login_data)) {
                ...
                color: #006573;
                font-weight: 600;"> Care1 Healthcare</a>
                  </p>
        ';
                mailmsg($email, 'Forgot Password  | From  Care1 Healthcare', $message);
    ...
    public function orders()
    {
        ...
        $data['title'] = ' Profile - CARE1 | Your One Care Medical';
        $data['logo'] = 'assets/logo.png';
        $data['contact'] = $this->contact;
    ...
    public function orderDetails($checkoutID = true)
    {
        ...
        $data['title'] = 'Orde Details - CARE1 | Your One Care Medical';
        $data['logo'] = 'assets/logo.png';
        $data['contact'] = $this->contact;
    ...
    public function orderInvoice($checkoutID = true)
    {
        ...
        $data['orderProductDetails'] = $this->CommonModel->getRowById('checkout_product', 'product_book_id', $checkoutID);
        $data['title'] = ' Your Order Invoice - CARE1 | Your One Care Medical';
        $data['logo'] = 'assets/logo.png';
        $data['contact'] = $this->contact;
                ...
                if ($this->input->post('final_amount') > 0) {
                    ...
                    if ($post != '') {
                        if ($this->input->post('payment_mode') == '1') {
                            ...
                            mailmsg($postdata['email'], 'Order Confirm - Care1 Healthcare pvt ltd', $this->load->view('invoice-mail', $invoice, true));
    ...
    public function payment_msg()
    {
        ...
        if ($_POST) {
            ...
            if ($_POST['transaction_status'] == 'Success') {
                ...
                mailmsg($checkoutdata['email'], 'Order Confirm - Care1 Healthcare pvt ltd', $this->load->view('invoice-mail', $invoice, true));
            }
            $data['message'] = $msg;
    ...
    public function booking_status()
    {
        ...
        $data['logo'] = 'assets/logo.png';
        $data['title'] = 'Payment Status - CARE1 | Your One Care Medical';
        $msg = '';
    ...
    public function privacy_policy()
    {
        ...
        $data['title'] = 'Privacy Policy - CARE1 | Your One Care Medical';
        $data['contact'] = $this->contact;
    ...
    public function shipping_policy()
    {
        ...
        $data['title'] = 'Shipping Policy - CARE1 | Your One Care Medical';
        $data['contact'] = $this->contact;
    ...
    public function term_condition()
    {
        ...
        $data['title'] = 'Terms & Condition - CARE1 | Your One Care Medical';
        $data['contact'] = $this->contact;
        $this->load->view('term-condition', $data);
    }
    public function about()
    {
        $data['title'] = 'About Us - CARE1 | Your One Care Medical';
        $data['testimonial'] = $this->CommonModel->getAllRowsInOrder('testimonial', 'id', 'desc');
        $data['contact'] = $this->contact;
        ...
        if (count($_POST) > 0) {
            ...
            if (!empty($login_data)) {
                if ($type == 'get_otp') {
                    ...
                    mailmsg($email, 'OTP from Care1', $otp . ' is the OTP');
                    print_r(json_encode([
                        'status' => 200,
                        'message' => 'OTP Sent',
                        'otp' => $otp,
    ...
    public function get_otp()
    {
        ...
        if ($data == 1) {
            ...
            $msg = $otp . " is the verification code to log in to your Care1 Healthcare account.";
