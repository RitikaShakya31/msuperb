                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-10">
                                                <input class="form-control" type="text" name="lab_location" required
                                                    value="<?= $data['lab_location'] ?>" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 mb-3">
                                        <div class="row">
                                            ...
                                            <div class="col-md-10">
                                                <input class="form-control" type="number" name="lab_contact"
                                                    maxlength="10" required value="<?= $data['lab_contact'] ?>"
                                                    readonly>
                                            </div>
                                        </div>
                                    </div>
                                                            ...
                                                            <select class="form-control" name="service[]" disabled>
                                                                ...
                                                                <?php if ($services) {
                                                                    foreach ($services as $service) {
                                                                        // Check if the current service matches the selected one in $provar
