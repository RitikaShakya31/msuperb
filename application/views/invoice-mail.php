                              ...
                              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                  <td style="padding-right: 0px;padding-left: 0px;" align="center">
                                    ...
                                    <img align="center" border="0" src="<?= base_url() ?>assets/images/logo.png"
                                      alt="Cart Icon" title="Cart Icon"
                                      style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 75%;max-width: 200px;"
                                      width="200" />
                            ...
                            <td
                              ...
                              <div
                                ...
                                <p style="font-size: 14px; line-height: 140%;"><span
                                    ...
                                    <?= $order['name'] ?>, we're getting your order ready to be shipped.
                                  </span></p>
                                <p style="font-size: 14px; line-height: 140%;"><span
                          ...
                          <tr>
                            <td
                              ...
                              <div style="font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;">
                                ...
                                <p style="font-size: 14px; line-height: 140%;"><span
                                    style="font-family: Montserrat, sans-serif; font-size: 14px; line-height: 19.6px;text-transform:uppercase">
                                    <?= $order['name'] ?>
                                  </span><br /><span
                                    style="font-family: Montserrat, sans-serif; font-size: 14px; line-height: 19.6px;">Shipping
                        ...
                        <tbody>
                          <tr>
                            <td
                              ...
                              <div style="font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;">
                                <p style="font-size: 14px; line-height: 140%;"><strong><span
                                      style="font-family: Montserrat, sans-serif; font-size: 14px; line-height: 19.6px;">Order
                                ...
                                <p style="font-size: 14px; line-height: 140%;"><span
                                    style="font-family: Montserrat, sans-serif; font-size: 14px; line-height: 19.6px;">Date:
                                    <?= $order['create_date'] ?>
                                  </span></p>
                                <p style="font-size: 14px; line-height: 140%;">&nbsp;</p>
                              </div>
                                ...
                                <tr>
                                  <td style="padding-right: 0px;padding-left: 0px;" align="center">
                                    ...
                                    <img align="center" border="0"
                                      src="<?= base_url() ?>upload/product/<?= $pro['product_img'] ?>" alt="Hand Bag"
                                      title="Hand Bag"
                        ...
                        <tbody>
                          <tr>
                            <td
                              ...
                              <div style="font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;">
                                <p style="font-size: 14px; line-height: 140%;"><span
                                    style="font-family: Montserrat, sans-serif; font-size: 14px; line-height: 19.6px;"><strong>
                                      <?= $pro['product_name'] ?> - <?= $pro['variant_name'] ?> 
                                    </strong><span style="color: #666666; font-size: 14px; line-height: 19.6px;">x
                                      <?= $pro['no_of_items'] ?>
                                    </span></span></p>
                              </div>
                            ...
                            <td
                              ...
                              <div style="font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;">
                                <p style="font-size: 14px; line-height: 140%;"><span
                                    ...
                                    </strong><span style="color: #666666; font-size: 14px; line-height: 19.6px;">Rs. 
                                      <?= $pro['booking_price'] ?>
                                    </span></span></p>
                              </div>
                        ...
                        <tbody>
                          <tr>
                            <td
                              ...
                              <div style="font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;">
                              <p style="font-size: 14px; line-height: 140%;"><span
                                    style="font-family: Montserrat, sans-serif; font-size: 14px; line-height: 19.6px;">GST</span>
                                </p>
                                <p style="font-size: 14px; line-height: 140%;"><span
                                ...
                                <p
                                  style="font-size: 14px; line-height: 140%;<?= ($order['promocode_amount'] == '')? 'display:none':'' ?>">
                                  <span
                                    style="font-family: Montserrat, sans-serif; font-size: 14px; line-height: 19.6px;">Promo.
                                    Amt.</span>
                                </p>
                              </div>
                            </td>
                        ...
                        <tbody>
                          <tr>
                            <td
                              ...
                              <div style="font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;">
                              <p style="font-size: 14px; line-height: 140%;"><span
                                    style="font-family: Montserrat, sans-serif; font-size: 14px; line-height: 19.6px;">Rs.
                                    <?= $gst ?>
                                  </span></p>
                                   <p style="font-size: 14px; line-height: 140%;"><span
                                    style="font-family: Montserrat, sans-serif; font-size: 14px; line-height: 19.6px;">Rs.
                        ...
                        <tbody>
                          <tr>
                            <td
                              ...
                              <table height="0px" align="right" border="0" cellpadding="0" cellspacing="0" width="50%"
                                style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;border-top: 2px solid #e7e7e7;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%">
                                <tbody>
                                  <tr style="vertical-align: top">
                                    <td
                              ...
                              <div style="font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;">
                                <p style="font-size: 14px; line-height: 140%;"><span
                                    style="font-size: 16px; line-height: 22.4px;"><strong><span
                                        style="font-family: Montserrat, sans-serif; line-height: 22.4px; font-size: 16px;">Rs.
                                        <?= $order['final_amount'] ?>
                                      </span></strong></span></p>
                              </div>
                          ...
                          <tr>
                            <td
                              ...
                              <div
                                ...
                                <p style="font-size: 14px; line-height: 140%;"><a href="mailto:+91-<?= $contact['email_f'] ?>" style="color:#555555"><span
                                    style="font-family: Montserrat, sans-serif; font-size: 14px; line-height: 19.6px;"><strong>email</strong> us at <?= $contact['email_f'] ?>
                                    or <strong>contact us</strong> at </span></a></p>
                                <p style="font-size: 14px; line-height: 140%;"><a href="tel:+91-<?= $contact['contact_f'] ?>" style="color:#555555"><span
                                    style="font-family: Montserrat, sans-serif; font-size: 14px; line-height: 19.6px;">+91-<?= $contact['contact_f'] ?></span></a></p>
                              </div>
