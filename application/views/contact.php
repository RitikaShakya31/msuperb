        ...
        <div class="row">
            ...
            <div class="col-md-12 col-lg-12  text-center p-3"> 
                     <ul class="footer-social">
						<li><a class="icofont-facebook" href="https://www.facebook.com/Care1healthcare" target="_blank"></a></li>

						<li><a class="icofont-instagram" href="https://www.instagram.com/Care1healthcare/"  target="_blank"></a></li>
							<li><a class="icofont-twitter" href="https://twitter.com/Care1healthcare"  target="_blank"></a></li>
							<li><a class="icofont-linkedin" href="https://www.linkedin.com/company/101022240"  target="_blank"></a></li>
            ...
            <div class="col-lg-6">
                <form method="post" class="contact-form">
                    ...
                    <div class="form-group">
                        <div class="form-input-group"><input class="form-control" type="text" placeholder="Your Phone" maxlength="10" onkeypress="return event.charCode >= 48 && event.charCode <= 57" name="phone"><i class="icofont-phone"></i></div>
                    </div>
                    <div class="form-group">
